...
local carregaTitleLabel = function()
	titleLabel = display.newText( "Bluetooth Play", 0, 0, templateDefaultFont, templateDefaultTitleSizeFont )
...
local carregaBodyTextLabel = function()
	local path = system.pathForFile( "bluetoothgameplayinstructions.txt", system.ResourceDirectory )
